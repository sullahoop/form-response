...
export class GaruWasm {
    ...
    analyze(text) {
        try {
            ...
            wasm.garuwasm_analyze(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    analyze_topn(text, n) {
        try {
            ...
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.garuwasm_analyze_topn(retptr, this.__wbg_ptr, ptr0, len0, n);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    tokenize(text) {
        try {
            ...
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.garuwasm_tokenize(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
import * as import1 from "./snippets/garu-core-8461f1cf9a271495/inline0.js"
...
function __wbg_get_imports() {
    ...
    return {
        ...
        "./snippets/garu-core-8461f1cf9a271495/inline0.js": import1,
    };
}
